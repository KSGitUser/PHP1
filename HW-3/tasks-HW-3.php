...
echo $lineBracker;
$task = "<pre>6. В имеющемся шаблоне сайта заменить статичное меню (ul – li) на генерируемое
 ...
 * формировался по массиву. Не забудьте чтобы гиперссылки тоже были в массиве.</pre><br>";

echo $task;

echo '<br><a href="buildMenu.php">Открыть ссылку на меню в текущем окне</a><rb>';
